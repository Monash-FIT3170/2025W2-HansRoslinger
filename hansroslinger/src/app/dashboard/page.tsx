...
const Dashboard = async () => {
  ...
  return (
    <main className="flex-1 overflow-y-auto scroll-auto scroll-smooth lg:overflow-hidden">
      ...
      <section
        id="hero"
        className="relative py-24 px-6 overflow-hidden min-h-[65vh] flex items-center"
      >
        ...
        <div className="relative max-w-7xl mx-auto text-center w-full">
          ...
          <div className="mb-10">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold leading-tight tracking-tight">
              ...
              <br />
              <div
                className="relative inline-block mt-2 animate-slide-up"
          ...
          <div className="animate-slide-up" style={{ animationDelay: "800ms" }}>
            <p className="text-xl md:text-2xl text-[#4a4a4a]/90 mb-12 max-w-4xl mx-auto leading-relaxed font-bold">
              Interact with your data like never before. Upload, organise, and
              visualise with{" "}
              <span className="text-[#5C9BB8] font-semibold">
          ...
          <div
            className="flex items-center justify-center gap-6 flex-wrap mb-8 w-fit mx-auto animate-scale-in"
      ...
      <section
        id="gestures"
        className="py-24 px-6 mb-8 relative overflow-hidden"
      >
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center mb-20 animate-slide-up">
            <h2 className="text-4xl md:text-6xl font-bold mb-5 text-[#2a2a2a]">
              Master the{" "}
              <span className="gradient-text-enhanced">Gestures</span>
            </h2>
          ...
          <div className="flex flex-wrap justify-center gap-10">
            {gestures.map((g, idx) => (
              ...
              >
                ...
                <div
                  className={`absolute -inset-0.5 ${g.iconColor} opacity-0 blur-sm group-hover:opacity-30 transition-opacity duration-500 pointer-events-none`}
                ></div>
                ...
                <div className="relative p-7 flex flex-col items-center text-center">
                  ...
                  <div className="absolute top-5 right-5 z-10">
                    <div className="relative group/badge">
                      {/* Badge glow */}
                      <div
                        className={`absolute inset-0 ${g.iconColor} blur-md opacity-40 group-hover/badge:opacity-70 transition-opacity duration-300`}
                      ></div>
                      <div
                        className={`relative p-3 ${g.iconColor} shadow-lg group-hover:shadow-xl transition-all duration-300 group-hover:scale-110 group-hover:rotate-6`}
                      >
                        <g.ActionIcon
                  ...
                  <div className="relative w-full aspect-square mb-6 flex items-center justify-center">
                    <div
                      className={`absolute inset-0 ${g.iconColor} opacity-12 blur-3xl group-hover:opacity-25 group-hover:blur-[48px] transition-all duration-500`}
                    ></div>
                    <div className="relative flex justify-center items-center gap-4 w-full h-full bg-gradient-to-br from-[#F5F9FC] via-[#E8F0F7]/60 to-[#D8E4F0]/40 border border-[#5C9BB8]/15 shadow-inner overflow-hidden group-hover:scale-[1.03] transition-transform duration-500">
                      ...
                      {/* Corner accents */}
                      <div
                        className={`absolute top-0 left-0 w-8 h-8 border-t-2 border-l-2 border-current opacity-30 group-hover:opacity-60 transition-opacity duration-300 ${g.iconColor.replace("bg-", "text-")}`}
                      ></div>
                      <div
                        className={`absolute bottom-0 right-0 w-8 h-8 border-b-2 border-r-2 border-current opacity-30 group-hover:opacity-60 transition-opacity duration-300 ${g.iconColor.replace("bg-", "text-")}`}
                      ></div>
                      ...
                      {g.isDouble ? (
                        ...
                        <div
                          className={`relative z-10 p-5 ${g.iconColor} shadow-lg transition-all duration-300 group-hover:scale-110 group-hover:rotate-3`}
                        >
                          <g.GestureIcon
