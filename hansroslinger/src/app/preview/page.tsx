          ...
          <div className="text-center mb-12 animate-fade-in">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold mb-5 leading-tight tracking-tight">
              <div className="relative inline-block">
                <span className="gradient-text-enhanced drop-shadow-lg">Live</span>
              ...
              {" "}
              <span className="gradient-text-enhanced drop-shadow-lg">Preview</span>
            </h1>
            <p className="text-lg md:text-xl text-[#4a4a4a]/90 leading-relaxed max-w-3xl mx-auto mt-6 animate-slide-up" style={{ animationDelay: '200ms' }}>
