...
export const isAWSConfigured = !!(AWS_REGION && AWS_ACCESS_KEY_ID && AWS_SECRET_ACCESS_KEY);

if (!isAWSConfigured) {
  console.warn("AWS credentials not found in .env file. S3 functionality will be disabled.");
}
